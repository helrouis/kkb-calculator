...
import { Receipt, Plus, Trash2, Percent } from 'lucide-react';
...
export default function BillSplitter() {
  ...
  const calculateByPerson = () => {
    ...
    if (serviceChargeType === 'percent') {
      ...
      totalServiceCharge = grandSubtotal * (servicePercent / 100);
    } else {
    ...
    uniquePeople.forEach(person => {
      ...
      const personServiceCharge = grandSubtotal > 0 
        ? (subtotal / grandSubtotal) * totalServiceCharge 
        : 0;
      ...
      personTotals[person] = {
        ...
        total: subtotal + personServiceCharge
      };
    });
    
    const grandTotal = grandSubtotal + totalServiceCharge;
    
    return { personTotals, grandSubtotal, totalServiceCharge, grandTotal };
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {items.length > 0 && (
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-700 mb-3">All Items</h3>
